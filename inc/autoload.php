...
require_once FLANCE_BRANCHES_PATH . '/woocommerce-classes/function.php';
...
require_once FLANCE_BRANCHES_PATH . '/woocommerce-classes/order_package_split.php';
new OrderPackageSplit();