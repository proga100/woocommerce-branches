...
if (!class_exists('WC_Email_Customer_Dispatched_Child', false)) :
	 ...
	 * @extends     WC_Email
	 */
	class WC_Email_Customer_Dispatched_Child extends WC_Email
	{
		...
		{
			$this->id = 'customer_dispatched_child';
			$this->customer_email = true;

			$this->title = __('Dispatched ',  'woocommerce-branches');
			...
			$this->template_html = 'emails/customer-dispatched-child.php';
			$this->template_plain = 'emails/plain/customer-dispatched-child.php';
			...
			add_action('woocommerce_order_status_dispatched', array($this, 'trigger'), 20, 2);
		...
		{
			return __('Your {site_title} order has been dispatched!', 'woocommerce-branches');
		}
...
return new WC_Email_Customer_Dispatched_Child();
